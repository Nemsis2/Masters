...
class bi_lstm_package():
      ...
      def train_fss(self, fss_feature):
            ...
            feature_path = f'../../models/tb/resnet/resnet_18/{self.feature_type}/{self.n_feature}_{self.feature_type}/fss/docs/'
            if self.feature_type == 'mfcc':
      ...
      def save(self, fss_feature=0):
            ...
            elif self.model_type =='fss' or self.model_type == 'fss_on_resnet':
      ...
      def dev_fss(self, data, labels, names, lengths):
            results = []
...
def test_models_patients_on_select(models, num_features, test_fold, interpolate, batch_size, threshold):
      ...
      features = outer_fss(num_features)
